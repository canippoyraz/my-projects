    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::www.awsroutepoyraz/*"
        }
    ]
}
```
...
- After show "info.awsroutepoyraz.net" on the browser, "Delete" this record 


### STEP 3: Add another IP (N. Virginia_2)  to the existing "A record" 

- select "www.awsroutepoyraz.net" A-record ---> Edit
```bash
Name:"www"
Value/Route traffic to:
...
nslookup www.awsroutepoyraz.net an show two IP address 
...
- After show "showcname.awsroutepoyraz.net" on the browser. It will reflects the "www.awsroutepoyraz.net". After that "Delete"  this record 
...
Value/Route traffic to: 
    ...
    - choose your S3 bucket named "www.awsroutepoyraz.net"
Record Type : A
```
- hit the define simple record
...
- go to the target domain name "www.awsroutepoyraz.net" on browser
