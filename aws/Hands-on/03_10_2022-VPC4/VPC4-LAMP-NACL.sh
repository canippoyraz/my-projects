...
# 3.Create MariaDB ec2 instance in Private Subnet 1b
   ...
   VPC: "poyraz-vpc-a"
   Subnet: "poyraz-az1b-private-subnet"
...
# 13. Edit "poyraz-private-rt" route table:
...
# 19. Create new database named "poyrazdb".
CREATE DATABASE poyrazdb;

# 20. Create a user named "admin".
CREATE USER admin IDENTIFIED BY '123456789';

# 21. Grant permissions to the user "admin" for database "poyrazdb".
GRANT ALL ON poyrazdb.* TO admin IDENTIFIED BY '123456789' WITH GRANT OPTION;  
...
# 4. Select Subnet associations sub-menu ---> Edit subnet association ---> select "poyraz-az1a-private-subnet" ---> edit
...
# 6. Go to the NACL named "poyraz-private1a-nacl"
...
# 10. Go to the NACL named "poyraz-private1a-nacl"
