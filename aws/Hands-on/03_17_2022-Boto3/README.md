...
# Create a new bucket
s3.create_bucket(Bucket='poyraz-boto3-bucket')
...
i
```
- Check the "poyraz-boto3-bucket", if your script works fine, you should be able to see your test file in your bucket.
