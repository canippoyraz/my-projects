...
- discuss about how to connect to the "poyraz-az1b-private-subnet" instance
...
Target ----> Nat Gateway ----> poyraz-nat-gateway
```
- click save routes
...
- Select poyraz-nat-gateway --- > Actions ---> delete Nat Gateway
...
- Go to Route Table and select "poyraz-private-rt"
