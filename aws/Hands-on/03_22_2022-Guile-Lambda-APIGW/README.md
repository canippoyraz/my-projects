...
- Create a bucket of `poyraz.source.lambda` with following properties,

```text
Bucket name                 : poyraz.source.lambda
Region                      : N.Virginia
...
- Create another bucket of `poyraz.destination.lambda` with following properties,

```text
Bucket name                 : poyraz.destination.lambda
Region                      : N.Virginia
Block all public access     : Checked (KEEP BlOCKED)
Versioning                  : Disabled
Tagging                     : 0 Tags
...
def lambda_handler(event, context):
   destination_bucket_name = 'poyraz.destination.lambda'
...
- Select S3 bucket named 'poyraz.source.lambda'

- Upload any files to source bucket

- Go to the S3 bucket named 'poyraz.destination.lambda' and show the uploaded files to the source bucket.
